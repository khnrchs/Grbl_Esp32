...
*/
#define MACHINE_NAME            "ESP32 I2S 3 Axis (CNCShield)"
...
#define Y_DISABLE_PIN           I2SO(0) // single: Bit 4 
#define Y_DIRECTION_PIN         I2SO(5)
#define Y_STEP_PIN              I2SO(6)
// #define STEPPER_Y_MS3           I2SO(7)   // Y_CS

#define Z_DISABLE_PIN           I2SO(0) // single: Bit 8
